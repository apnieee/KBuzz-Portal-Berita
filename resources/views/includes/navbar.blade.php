<!-- Nav -->
    <div class="sticky top-0 z-50 flex justify-between py-5 px-4 lg:px-14 bg-white shadow-sm">
      <div class="flex gap-10 w-full">
        ...
        <div class="flex items-center justify-between w-full lg:w-auto">
          ...
          <a href="index.html">
            <div class="flex items-center gap-2">
              ...
              <p class="text-lg lg:text-xl font-bold">KBuzz</p>
            </div>
          </a>
        ...
        <!-- Menu Navigasi -->
        <div id="menu"
          <div class="flex items-center gap-2 mt-4 lg:mt-0 w-full lg:w-auto relative">
          <ul
            ...
            <li><a href="{{ route('landing') }}" 
              class="{{ request()->is('/') ? 'text-primary' : '' }} hover:text-gray-600a">
              Beranda
            </a>
          </li>
